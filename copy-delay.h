...
public:
  DelayedFunctions() {
    delayed_functions_.resize(Param::neighbors_per_agent_ * 10);
  }
...
void CopyDelay(NeighborMode mode, TWorkload workload_per_agent, TWorkloadNeighbor workload_neighbor, double expected) {
